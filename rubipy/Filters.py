...
class Filter:
    async def __call__(self, client: "rubipy.Client", update):
...
class InvertFilter(Filter):
    ...
    async def __call__(self, client: "pyrogram.Client", update):
...
async def channel_filter(_, __, m: Message):
    return bool(m.chat_type == "Channel")
...
async def new_chat_members_filter(_, __, m: Message):
    return bool(m.event_data.New_Member)
...
async def left_chat_member_filter(_, __, m: Message):
    return bool(m.event_data.Left_Member)
